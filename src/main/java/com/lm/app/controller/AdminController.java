...
import com.lm.app.dao.OrderDAO;
...
import com.lm.app.validator.ProductFormValidator;
...
public class AdminController {
    ...
    @RequestMapping(value = { "/admin/product/delete/{code}" }, method = RequestMethod.POST)
    public String deleteProduct(@PathVariable("code") String code, final RedirectAttributes redirectAttributes) {

        try {
            productDAO.delete(code);
            redirectAttributes.addFlashAttribute("message", "Product " + code + " was deleted.");
        } catch (Exception e) {
